...
async function main() {
  ...
  if (existsSync(subservicesPath)) {
    ...
    console.log(`\nGenerating ${subservices.length} subservice pages...`);
    // TODO: implement subservice page builder
    console.log("  (subservice generator not yet implemented)");
  }
