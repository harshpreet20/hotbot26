...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const pages: Array<{
    ...
    { path: "/marketing-services/seo",                     priority: 0.8, changeFrequency: "monthly" },
    { path: "/marketing-services/social-media",            priority: 0.8, changeFrequency: "monthly" },
    { path: "/marketing-services/ppc",                     priority: 0.8, changeFrequency: "monthly" },
    { path: "/marketing-services/email-marketing",         priority: 0.8, changeFrequency: "monthly" },
    { path: "/marketing-services/analytics",               priority: 0.8, changeFrequency: "monthly" },
    { path: "/marketing-services/cro",                     priority: 0.8, changeFrequency: "monthly" },
    ...
    { path: "/consultancy",                         priority: 0.9, changeFrequency: "monthly" },
    { path: "/consultancy/growth-strategy",         priority: 0.8, changeFrequency: "monthly" },
    { path: "/consultancy/digital-transformation",  priority: 0.8, changeFrequency: "monthly" },
    { path: "/consultancy/marketing-audit",         priority: 0.8, changeFrequency: "monthly" },
    { path: "/consultancy/martech-stack",           priority: 0.8, changeFrequency: "monthly" },
