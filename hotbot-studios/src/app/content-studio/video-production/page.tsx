...
// ── Content Data ──────────────────────────────────────────────────────────────
const SUB_SERVICES = [
  { icon: "🎬", title: "Brand Films", desc: "Cinematic brand stories that define who you are, what you stand for, and why customers should choose you. Shot in 4K, colour-graded to your brand palette, scored with original or licensed music.", href: "/content-studio/video-production" },
  { icon: "📦", title: "Product & Explainer Videos", desc: "60–90 second videos that demonstrate your product's value, simplify complex ideas, and overcome objections at the bottom of your funnel. Highest-converting video format for B2B SaaS and e-commerce.", href: "/content-studio/video-production" },
  { icon: "⭐", title: "Testimonial & Case Study Videos", desc: "Real customer success stories filmed professionally and edited to highlight measurable outcomes. The most trusted content type at the purchase decision stage — 89% of buyers say video testimonials influence their final choice.", href: "/content-studio/video-production" },
  { icon: "📱", title: "Short-Form Social (Reels & TikTok)", desc: "Platform-native vertical video built for Instagram Reels, TikTok, and YouTube Shorts. Trend-informed, hook-first, captioned, and optimised for the first 3 seconds that determine whether viewers scroll or stop.", href: "/content-studio/video-production" },
  { icon: "▶️", title: "YouTube Series & Long-Form", desc: "Episodic YouTube content that builds authority, grows a subscriber base, and compounds organic search traffic over time. Strategy, scripting, filming, editing, thumbnails, and SEO-optimised titles included.", href: "/content-studio/video-production" },
  { icon: "📡", title: "Video Ads (Meta & Google)", desc: "Direct-response video ads optimised for Meta (Facebook/Instagram), YouTube pre-roll, and Google Display — with split-test variations, platform-specific aspect ratios, and CTA-driven scripts built to convert.", href: "/content-studio/video-production" },
];
