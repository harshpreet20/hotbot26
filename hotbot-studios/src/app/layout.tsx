...
const orgSchema = {
  ...
  hasOfferCatalog: {
    ...
    itemListElement: [
      ...
      { "@type": "Offer", itemOffered: { "@type": "Service", name: "Digital Marketing", url: `${SITE_URL}/marketing-services` } },
      ...
      { "@type": "Offer", itemOffered: { "@type": "Service", name: "Marketing Consulting", url: `${SITE_URL}/consultancy` } },
    ],
  },
  sameAs: [],
};
