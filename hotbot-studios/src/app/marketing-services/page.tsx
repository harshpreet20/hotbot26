...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://hotbotstudios.com/marketing-services",
    images: [{ url: "/og-image.svg", width: 1200, height: 630, alt: "Digital Marketing Agency USA — HotBot Studios" }],
  },
  twitter: {
...
const serviceSchema = {
  ...
  "@type": "Service",
  name: "Digital Marketing Services for US Businesses",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Digital Marketing", item: "https://hotbotstudios.com/marketing-services" },
  ],
};
