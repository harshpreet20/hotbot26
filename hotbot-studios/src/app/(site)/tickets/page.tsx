  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch("/api/tickets", {
        ...
        body: JSON.stringify({ title, description, requesterName: name, requesterEmail: email, category, priority }),
      });
    ...
    <div className="min-h-screen py-16 px-4" style={{ background: "#0a0e1a" }}>
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-slate-400">Describe your issue and we'll get back to you within 24 hours.</p>
          <button
        ...
        {lookupMode ? (
          ...
          /* Submit form */
          <form onSubmit={handleSubmit} className="rounded-3xl p-8 space-y-6" style={{ border: "1px solid rgba(255,255,255,0.08)", background: "rgba(255,255,255,0.02)" }}>
            {error && (
