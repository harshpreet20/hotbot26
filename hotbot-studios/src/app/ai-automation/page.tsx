...
export const metadata: Metadata = {
  title: "AI Automation Agency USA — Custom AI Agents & Workflows | HotBot Studios",
  description:
    "HotBot Studios builds custom AI agents, voice assistants (Heka), chatbots, and n8n workflow automations for US businesses. Save 200+ hours/month, qualify more leads, and scale without adding headcount. Free AI audit.",
  keywords: [
    ...
    "workflow automation for small business USA",
    "AI automation ROI",
  ...
  openGraph: {
    title: "AI Automation Agency USA — Custom AI Agents & Workflows | HotBot Studios",
    description: "Custom AI agents, voice AI, chatbots, and n8n workflows for US businesses. Save 200+ hours/month and scale without adding headcount. Free AI audit.",
    url: "https://hotbotstudios.com/ai-automation",
    images: [{ url: "/og-image.svg", width: 1200, height: 630, alt: "AI Automation Agency USA — HotBot Studios" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "AI Automation Agency USA | HotBot Studios",
    description: "Custom AI agents, chatbots, voice AI & n8n automation for US businesses. 200+ hours saved monthly.",
  },
...
const serviceSchema = {
  ...
  description: "Custom AI agents, voice AI (Heka), chatbots, n8n workflow automation, and LLM integrations for US businesses. Save 200+ hours monthly and scale operations without adding headcount.",
  url: "https://hotbotstudios.com/ai-automation",
