...
import type { DashboardOverview, Lead, Contact, CallbackRequest } from "@/types/dashboard";

function getSecret() {
  return typeof window !== "undefined" ? sessionStorage.getItem("backdrop_secret") || "" : "";
}

interface StatCardProps { label: string; value: number; href: string; color: string; icon: React.ReactNode }
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
              <StatCard label="Blog Posts"    value={data.posts}      href="/enter/backdrop/dashboard/blog"       color="#3b82f6"
              ...
              />
              <StatCard label="Leads"         value={data.leads}      href="/enter/backdrop/dashboard/leads"      color="#22c55e"
              ...
              />
              <StatCard label="Contact Msgs"  value={data.contacts}   href="/enter/backdrop/dashboard/contacts"   color="#8b5cf6"
              ...
              />
              <StatCard label="Chat Sessions" value={data.chats}      href="/enter/backdrop/dashboard/chats"      color="#f59e0b"
              ...
              />
              <StatCard label="Callbacks"     value={data.callbacks}  href="/enter/backdrop/dashboard/callbacks"  color="#ec4899"
              ...
              />
              <StatCard label="Newsletter"    value={data.newsletter} href="/enter/backdrop/dashboard/newsletter" color="#06b6d4"
