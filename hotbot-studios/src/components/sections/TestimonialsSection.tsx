    ...
    <section className="relative z-10 py-20 sm:py-28 overflow-hidden">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <Reveal>
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white text-center mb-3">What Our Clients Say</h2>
        ...
        <div className="relative">
          ...
          <div className="flex items-center justify-center gap-4 sm:gap-6 mt-8 sm:mt-10">
            <button onClick={() => { prev(); resetTimer(); }} className="w-10 h-10 sm:w-11 sm:h-11 rounded-full border border-white/[0.1] bg-white/[0.03] flex items-center justify-center text-slate-400 hover:text-white hover:border-blue-500/40 hover:bg-blue-500/10 transition-all duration-300">
            ...
            <button onClick={() => { next(); resetTimer(); }} className="w-10 h-10 sm:w-11 sm:h-11 rounded-full border border-white/[0.1] bg-white/[0.03] flex items-center justify-center text-slate-400 hover:text-white hover:border-blue-500/40 hover:bg-blue-500/10 transition-all duration-300">
