...
export const metadata: Metadata = {
  title: "Best AI Chatbots in the United States | HotBot Studios",
  description:
    "HotBot Studios builds the best AI chatbots in the United States — GPT-4o chatbots for web, WhatsApp & Instagram DMs that qualify leads 24/7. Book a free demo today.",
  keywords: [
    "best AI chatbots in the United States",
    "AI chatbot agency USA",
    "AI chatbot company USA",
    "AI chatbot services United States",
    "GPT-4o website chatbot",
    "WhatsApp Business AI chatbot",
    "AI lead generation chatbot USA",
    "AI customer support chatbot USA",
  ...
  openGraph: {
    title: "Best AI Chatbots in the United States | HotBot Studios",
    description: "HotBot Studios builds the best AI chatbots in the United States — GPT-4o chatbots for web, WhatsApp & Instagram DMs that qualify leads 24/7. Book a free demo today.",
    url: "https://hotbotstudios.com/ai-automation/ai-chatbots",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Best AI Chatbots in the United States - HotBot Studios" }],
  },
  twitter: {
...
const serviceSchema = {
  ...
  "name": "HotBot Studios - AI Chatbot Development",
  "url": "https://hotbotstudios.com/ai-automation/ai-chatbots",
  "description": "Custom AI chatbots for websites, WhatsApp Business, Telegram, and Instagram DMs. GPT-4o powered lead qualification running 24/7 for US businesses.",
  "provider": {
    "@type": "Organization",
    "name": "HotBot Studios",
...
const RELATED = [
    { title: "Custom AI Agents", href: "/ai-automation/custom-ai-agents", desc: "Autonomous agents that research and personalize follow-up at scale.", icon: "🤖" },
    { title: "n8n Workflow Automation", href: "/ai-automation/n8n-workflow-automation", desc: "Automate post-chatbot workflows: CRM updates, tasks, and follow-up emails.", icon: "⚙️" },
    { title: "LLM & GPT Integration", href: "/ai-automation/llm-gpt-integration", desc: "Embed GPT-4o and Claude 3 into your existing products and tools.", icon: "🧠" },
    { title: "Voice AI (Heka)", href: "/ai-automation/voice-ai-heka", desc: "AI phone receptionist for inbound calls — the voice version of your chatbot.", icon: "🎙️" },
    { title: "Software Development", href: "/software-development", desc: "Custom platforms and apps to power your AI systems.", icon: "💻" },
    { title: "Digital Marketing", href: "/digital-marketing", desc: "Drive qualified traffic to your AI-powered lead funnel.", icon: "📣" },
];
