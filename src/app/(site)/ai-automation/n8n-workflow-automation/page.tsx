...
export const metadata: Metadata = {
  title: "Best n8n Workflow Automation in the United States | HotBot Studios",
  description:
    "HotBot Studios provides the best n8n workflow automation in the United States — connect HubSpot, Salesforce & 500+ tools to eliminate manual work. Book a free workflow audit.",
  keywords: [
    "best n8n workflow automation in the United States",
    "n8n workflow automation agency USA",
    "n8n automation company USA",
    "workflow automation services United States",
    "business process automation USA",
    "HubSpot automation workflows",
    "Salesforce workflow automation USA",
    "Zapier alternative n8n USA",
    "CRM automation workflows USA",
    "Slack automation integration",
    "automated business workflows USA",
    "n8n developer USA",
  ],
  openGraph: {
    title: "Best n8n Workflow Automation in the United States | HotBot Studios",
    description: "HotBot Studios provides the best n8n workflow automation in the United States — connect HubSpot, Salesforce & 500+ tools to eliminate manual work. Book a free workflow audit.",
    url: "https://hotbotstudios.com/ai-automation/n8n-workflow-automation",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Best n8n Workflow Automation in the United States - HotBot Studios" }],
  },
  twitter: {
...
const serviceSchema = {
  ...
  "name": "HotBot Studios - n8n Workflow Automation",
  "url": "https://hotbotstudios.com/ai-automation/n8n-workflow-automation",
  "description": "n8n automation workflows connecting your CRM, email, Slack, Google Sheets, and 500+ tools, eliminating manual data entry and repetitive tasks for US businesses.",
  "provider": {
    "@type": "Organization",
    "name": "HotBot Studios",
...
export default function N8nWorkflowAutomationPage() {
  return (
    <>
      ...
      <Breadcrumb items={[{ label: "AI Automation", href: "/ai-automation" }, { label: "N8N Workflow Automation" }]} />
