...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Heka, The AI Voice Receptionist That Never Misses a Lead" }],
  },
  twitter: {
...
const serviceSchema = {
  ...
  "name": "HotBot Studios - Heka Voice AI Receptionist",
  "url": "https://hotbotstudios.com/ai-automation/voice-ai-heka",
  "description": "AI voice receptionist (Heka) that qualifies inbound leads, answers FAQs, and books calendar appointments 24/7. Integrates with HubSpot, Salesforce, and Calendly for US businesses.",
  "provider": {
    "@type": "Organization",
    "name": "HotBot Studios",
