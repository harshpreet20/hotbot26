...
export const metadata: Metadata = {
  title: "Best AI Analytics in the United States | HotBot Studios",
  description:
    "HotBot Studios delivers the best AI analytics & business intelligence in the United States — predictive dashboards, BigQuery & GA4 pipelines. Book your free data audit today.",
  keywords: [
    "best AI analytics in the United States",
    "AI analytics agency USA",
    "AI analytics company USA",
    "AI analytics services United States",
    "business intelligence dashboard USA",
    "predictive analytics company USA",
    "AI forecasting models USA",
    "Looker Studio BI dashboard",
    "BigQuery analytics USA",
    "GA4 AI analytics",
  ...
  openGraph: {
    title: "Best AI Analytics in the United States | HotBot Studios",
    description: "HotBot Studios delivers the best AI analytics & business intelligence in the United States — predictive dashboards, BigQuery & GA4 pipelines. Book your free data audit today.",
    url: "https://hotbotstudios.com/ai-automation/ai-analytics",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Best AI Analytics in the United States - HotBot Studios" }],
  },
  twitter: {
