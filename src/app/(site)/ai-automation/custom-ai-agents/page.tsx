...
export const metadata: Metadata = {
  title: "Best Custom AI Agents in the United States | HotBot Studios",
  description:
    "HotBot Studios builds the best custom AI agents in the United States — GPT-4o & Claude 3 autonomous agents for workflows, lead qualification & decisions 24/7. Book a free strategy call.",
  keywords: [
    "best custom AI agents in the United States",
    "custom AI agents agency USA",
    "custom AI agents company USA",
    "AI agent services United States",
    "autonomous AI agents for business",
    "GPT-4o business agents",
    "Claude 3 AI automation USA",
    "AI workflow agents USA",
    "AI lead qualification agent",
    "business process AI agents",
    "LLM agents for enterprise USA",
    "AI agent development company USA",
  ],
  openGraph: {
    title: "Best Custom AI Agents in the United States | HotBot Studios",
    description: "HotBot Studios builds the best custom AI agents in the United States — GPT-4o & Claude 3 autonomous agents for workflows, lead qualification & decisions 24/7. Book a free strategy call.",
    url: "https://hotbotstudios.com/ai-automation/custom-ai-agents",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Best Custom AI Agents in the United States - HotBot Studios" }],
  },
  twitter: {
...
const serviceSchema = {
  ...
  "name": "HotBot Studios - Custom AI Agents",
  "url": "https://hotbotstudios.com/ai-automation/custom-ai-agents",
  "description": "Autonomous AI agents on GPT-4o, Claude 3, and Gemini that handle multi-step workflows, lead qualification, research, and decision-making 24/7 for US businesses.",
  "provider": {
    "@type": "Organization",
    "name": "HotBot Studios",
