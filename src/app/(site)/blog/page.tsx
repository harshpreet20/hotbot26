...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title = "AI Automation & Digital Marketing Blog for US Businesses | HotBot Studios";
  const description =
    "Expert insights on AI automation, n8n workflows, SEO, content marketing, and software development for US businesses. Updated weekly by HotBot Studios experts.";
  ...
  return {
    ...
    openGraph: {
      ...
      title: "AI Automation & Digital Marketing Blog | HotBot Studios",
      description,
      url: `${SITE_URL}/blog`,
      images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "HotBot Studios Blog - AI & Marketing Insights" }],
    },
    twitter: {
      card: "summary_large_image",
      title: "HotBot Studios Blog | AI Automation & Digital Marketing for US Businesses",
      description,
      images: ["/og-image.png"],
...
export default function BlogPage() {
  ...
  // Blog JSON-LD - identifies this page as the canonical blog hub for HotBot Studios
  const blogSchema = {
    ...
    url: `${SITE_URL}/blog`,
    description:
      "Expert insights on AI automation, digital marketing, SEO, content strategy, and software development for US businesses.",
    publisher: {
      "@type": "Organization",
      name: "HotBot Studios",
      url: SITE_URL,
