...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://hotbotstudios.com/marketing-consulting",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Marketing Consulting USA - HotBot Studios" }],
  },
  twitter: {
  ...
  alternates: { canonical: "https://hotbotstudios.com/marketing-consulting" },
};
...
// ── Content Data ─────────────────────────────────────────────────────────────
const SUB_SERVICES = [
  { icon: "🗺️", title: "Growth Strategy & Roadmap", desc: "Build a clear, executable 90-day and 12-month growth roadmap - from market analysis and competitive positioning through to channel mix and budget allocation. Grounded in data, not guesswork.", href: "/marketing-consulting/growth-strategy" },
  { icon: "🔄", title: "Digital Transformation", desc: "Modernize your marketing tech stack (MarTech), automate manual processes, and upskill your team's digital capabilities. We've led digital transformations for companies from $2M to $200M in revenue.", href: "/marketing-consulting/digital-transformation" },
  { icon: "📊", title: "Marketing Audit & Gap Analysis", desc: "A comprehensive 360° review of your current marketing - channels, spend, creative, messaging, tech stack, and attribution. Delivered as a prioritized list of quick wins and strategic opportunities.", href: "/marketing-consulting/marketing-audit" },
  { icon: "🏗️", title: "MarTech Stack Design & Implementation", desc: "Select, configure, and integrate the right CRM (HubSpot, Salesforce), marketing automation (Marketo, ActiveCampaign), and analytics tools for your team size, budget, and goals.", href: "/marketing-consulting/martech-stack" },
  { icon: "👥", title: "Marketing Team Building & Training", desc: "Help you hire, structure, and upskill your in-house marketing team. Includes role scoping, interview frameworks, onboarding plans, and 1:1 coaching for your marketing leaders.", href: "/marketing-consulting/team-building" },
  { icon: "🌍", title: "Go-To-Market & Market Entry", desc: "Research, positioning, messaging, channel strategy, and launch support for entering new US markets, launching new products, or targeting new customer segments.", href: "/marketing-consulting/go-to-market" },
];
...
const RELATED = [
  { title: "Digital Marketing", href: "/digital-marketing", desc: "Execute the growth strategy we build together.", icon: "📣" },
...
export default function ConsultancyPage() {
  return (
    <>
      ...
      <Breadcrumb items={[{ label: "Marketing Consulting", href: "/marketing-consulting" }]} />
