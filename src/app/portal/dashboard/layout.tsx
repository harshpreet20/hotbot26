...
function FolderIcon()  { return <svg width="16" height="16" viewBox="0 0 24 24" fill="none"><path d="M22 19a2 2 0 01-2 2H4a2 2 0 01-2-2V5a2 2 0 012-2h5l2 3h9a2 2 0 012 2z" stroke="currentColor" strokeWidth="2" strokeLinejoin="round"/></svg>; }
function StarIcon()    { return <svg width="16" height="16" viewBox="0 0 24 24" fill="none"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" stroke="currentColor" strokeWidth="2" strokeLinejoin="round"/></svg>; }
...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Feature Requests",  href: "/portal/dashboard/feature-requests", icon: StarIcon,   exact: false },
    ],
  },
  {
    label: "BILLING",
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Files",      href: "/portal/dashboard/files",      icon: FolderIcon,   exact: false },
    ],
  },
  {
    label: "LEGAL",
